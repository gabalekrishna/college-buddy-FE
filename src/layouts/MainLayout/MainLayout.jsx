...
import SellBookModal from "../../components/SellBookModal/SellBookModal";
    ...
    <Box sx={{ display: "flex", flexDirection: "column", height: "100%" }}>
      <Toolbar sx={{ px: 2 }}>
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          <img
            src="https://codedthemes.com/wp-content/uploads/2021/09/berry-logo.svg"
            alt="Berry"
            width={24}
          />
